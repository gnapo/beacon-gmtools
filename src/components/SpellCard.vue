...
<template>
  <div class="card-flexcol">
    <div class="card-top spell-top" :class="{'passive-ability': item.Action === '', 'action': item.Action.includes('Action'), 'reaction': item.Action.includes('Reaction'), 'attack-action': item.Damage !== '' }" >
